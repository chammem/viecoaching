 ...
 */
final class Version20240306142459 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE ressources_utilisateur (ressources_id INT NOT NULL, utilisateur_id INT NOT NULL, INDEX IDX_85B94C4F3C361826 (ressources_id), INDEX IDX_85B94C4FFB88E14F (utilisateur_id), PRIMARY KEY(ressources_id, utilisateur_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
