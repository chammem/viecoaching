 ...
 */
final class Version20240216165518 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE categorie ADD ressource_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE categorie ADD CONSTRAINT FK_497DD634FC6CD52A FOREIGN KEY (ressource_id) REFERENCES ressources (id)');
        $this->addSql('CREATE INDEX IDX_497DD634FC6CD52A ON categorie (ressource_id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE ressources_categorie (ressources_id INT NOT NULL, categorie_id INT NOT NULL, INDEX IDX_410D02353C361826 (ressources_id), INDEX IDX_410D0235BCF5E72D (categorie_id), PRIMARY KEY(ressources_id, categorie_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_general_ci` ENGINE = InnoDB COMMENT = \'\' ');
        ...
        $this->addSql('DROP INDEX IDX_497DD634FC6CD52A ON categorie');
        $this->addSql('ALTER TABLE categorie DROP ressource_id');
        $this->addSql('ALTER TABLE messenger_messages CHANGE delivered_at delivered_at DATETIME DEFAULT \'NULL\'');
    }
}
